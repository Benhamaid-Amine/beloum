...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Amine Bnh</span>
    </a>
   ...
   <section id="Hero" class="bg-white dark:bg-gray-900">
                                      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                                          ...
                                          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Digital Dreams Unleashed.</h1>
                                          <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Crafting digital success by blending technology, innovation, and strategic growth, we're the driving force at AmineBnh™</p>
                                          <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                                              <a href="#work" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                                                  Learn more
   ...
   <section id="About" class="bg-white dark:bg-gray-900">
    <h2 class="text-3xl text-center font-extrabold leading-tight tracking-tight text-gray-900 sm:text-4xl dark:text-white">
      About us
    </h2>
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-4 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Let's forge innovative solutions and concepts that unite us in the digital realm</h2>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">At AmineBnh, we specialize in crafting web solutions that foster connections within communities and among individuals. Seamlessly connect with your network and explore new horizons effortlessly through features tailored for collaboration, like our Groups functionality.</p>
            <a href="#" class="inline-flex items-center text-white bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Get started
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
        </div>
   ...
   <!-- products -->
 <section id="work" class="bg-white dark:bg-gray-900 antialiased">
                                      <div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
                                        ...
                                        <div class="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 ">
                                          <div class="space-y-4">
                                          <span
                                            ...
                                            <img class="h-auto max-w-full" src="./images/web2.jpg" alt="image description">
                                            <h3 class="text-2xl font-bold leading-tight text-gray-900 dark:text-white">
                                              Web Development
                                            </h3>
                                            <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                                              AmineBnh™ empowers you to link with like-minded individuals, bridging communities through shared passions in web development.
                                            </p>
                                            <a href="ShowWeb.php" title=""
                                              class="text-white bg-blue-600 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                              role="button">
                                              View case study
                                          ...
                                          <span
                                            ...
                                            <img class="h-auto max-w-full" src="./images/cms.jpg" alt="image description">
                                            <h3 class="text-2xl font-bold leading-tight text-gray-900 dark:text-white">
                                            Content Management system
                                            </h3>
                                            <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                                              AmineBnh™ bridges the gap, enabling connections among communities, friends, and those sharing common interests in CMS.
                                            </p>
                                            <a href="ShowCMS.php" title=""
                                              class="text-white bg-blue-600 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                              role="button">
                                              View case study
                                              <svg aria-hidden="true" class="w-5 h-5 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
...
<section id="FAQ" class="my-20">
  <h2 class="mb-8 text-4xl tracking-tight text-center font-extrabold text-gray-900 dark:text-white">Frequently asked questions</h2>
  
<div id="accordion-collapse" data-accordion="collapse">
  <h2 id="accordion-collapse-heading-1">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
      <span>What is the difference between frontend and backend development?</span>
  ...
  <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
      <p class="mb-2 text-gray-500 dark:text-gray-400">Frontend development refers to the part of a website or application visible to users, focusing on the design, layout, and interactivity using languages like HTML, CSS, and JavaScript. Backend development involves the server-side operations that power the frontend, handling databases, logic, and server configuration, often using languages like Python, PHP, or Node.js.</p>
      
    </div>
  </div>
  <h2 id="accordion-collapse-heading-2">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
      <span>What is a responsive web design, and why is it important?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">Responsive web design ensures that a website adapts and looks good on various devices and screen sizes, such as desktops, tablets, and smartphones. It's crucial as it provides an optimal viewing experience, improves user engagement, and positively impacts SEO by accommodating different user preferences for accessing the web.</p>
      
    </div>
  </div>
  <h2 id="accordion-collapse-heading-3">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
      <span>What are Content Management Systems (CMS), and why use them?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">CMS platforms like WordPress, Drupal, or Joomla provide tools to create, manage, and modify digital content (such as websites) without requiring advanced technical skills. They offer templates, plugins, and user-friendly interfaces, empowering users to update content, add functionalities, and maintain their websites efficiently. CMSs streamline website management, allowing focus on content creation rather than intricate coding.</p>
...
<form  action="conn.php" method="POST" id="Contact" class="max-w-md mx-auto p-4">
<div class="grid md:grid-cols-2 md:gap-6">
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    <div class="relative z-0 w-full mb-5 group">
        ...
        <label for="floating_phone" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone  (1234567890)</label>
    </div>
    <div class="relative z-0 w-full mb-5 group">
...
<textarea name="Sujet" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>

  <button onclick="submitForm()"  id="btn" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-2">Submit</button>
...
<script>
  ...
  event.preventDefault(); // Prevent the default form submission behavior
    ...
    document.getElementById('btn').addEventListener('click', function() {
      var hiddenAlert = document.getElementById('alert-border-3');
      var hiddenAlert2 = document.getElementById('alert-border-2');
      var fname=document.getElementById('floating_first_name').value;
      var lname=document.getElementById('floating_last_name').value;
      var email=document.getElementById('alert-border-3').value;
      var phone=document.getElementById('floating_phone').value;
      var company=document.getElementById('floating_company').value;
      var sujet=document.getElementById('message').value;
      if(fname=="" || lname=="" || email=="" || phone=="" ||company=="" || sujet=="" ){
        hiddenAlert2.classList.toggle('hidden');
      }
      else{
        hiddenAlert.classList.toggle('hidden');
      }
      
    });
  </script>
<!-- Modal toggle           id="successAlert"-->
<div id="alert-border-3" class="hidden flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800" role="alert">
...
<footer class="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">AmineBnh™</a>. All Rights Reserved.</span>
    </div>
</footer>
